...
createApp({
  ...
  mounted() {
	...
	// 啟用productModal
	productItemModal =  new bootstrap.Modal(document.getElementById('productItemModal'), {
		keyboard: false
	})
	
	// 啟用delProductModal
	delProductItemModal =  new bootstrap.Modal(document.getElementById('delProductItemModal'), {
		keyboard: false
	})	
  }
}).mount('#app');
